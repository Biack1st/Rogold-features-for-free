...
pages.outfitcopy = async () => {
    ...
    const outfitInfo = await get(`https://avatar.roblox.com/v1/users/${userId}/outfits`)
    ...
    <div avatar-tab-content="" class="tab-content">
        <div class="tab-pane ng-scope active" id="costumes">
            <div avatar-items=""><div class="items-list avatar-item-list">
                <div class="container-header"><h1>${userInfo.name}'s Outfits</h1></div>
                                ...
                                <div class="item-card-container remove-panel outfit-card">
                                    ...
                                    <div class="item-card-caption">
                                        <a class="item-card-name-link">
                                            <div title="${target?.name}" class="text-overflow item-card-name ng-binding">${target?.name}</div>
                                        </a> 
                                    </div>
                                </div>
                            </div> 
                        ...
                        <div class="item-card-container remove-panel outfit-card">
                            <div class="item-card-link">
                                <a class="item-card-thumb-container" href="/catalog/${outfitData.id}">
                                    <thumbnail-2d class="item-card-thumb ng-isolate-scope">
                                        <span class="thumbnail-2d-container">
                                            <img image-load="" alt="" title="" class="ng-scope ng-isolate-scope" src="https://www.roblox.com/asset-thumbnail/image?assetId=${outfitData.id}&width=420&height=420&format=png">
                                        </span>
                                    </thumbnail-2d>
                                </a> 
                            </div> 
                            <div class="item-card-caption">
                                <a class="item-card-name-link">
                                    <div title="${outfitData.name}" class="text-overflow item-card-name ng-binding">${outfitData.name}</div>
                                </a> 
                            </div>
                        </div>
                    </div> 
