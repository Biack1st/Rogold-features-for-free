...
pages.group = (async () => {
    ...
    if (window.location.href.includes("configure")) {
                ...
                <div class="group-header">
                    ...
                    <div ng-if="!layout.loadGroupError" class="group-caption ng-scope">
                        ...
                        <div class="group-title" ng-hide="layout.isLoadingGroup">
                            <h1 class="group-name text-overflow ng-binding" ng-bind="library.currentGroup.group.name">${groupStats.name}</h1>
                            ...
                            <a class="text-link ng-binding ng-scope" ng-bind="library.currentGroup.group.owner.displayName" href="https://www.roblox.com/users/${groupStats?.owner?.userId}/profile">${groupStats?.owner?.username}</a>
                        ...
                        <div class="group-info" ng-hide="layout.isLoadingGroup">
                            <ul class="group-stats">
                                ...
                                <li ng-if="canViewGroupRank()" class="group-rank text-overflow ng-scope">
                                    <span class="text-overflow font-header-2 ng-binding" title="Creator" ng-bind="library.currentGroup.role.name">${membership.userRole.role.name}</span> 
                        ...
                        <div class="section">
                            ...
                            <div class="section-content remove-panel">
                                ...
                                <div class="group-description toggle-target ng-scope" ng-if="$ctrl.canViewDescription()">
                                    ...
                                    <span class="group-description-content-text ng-binding" ng-bind-html="$ctrl.description | linkify">${groupStats.description}</span>
                                    </pre>
                                </div>
                    ...
                    <div style="display: ${groupStats.shout && "block" || "none"}" id="group-shout" class="section group-shout ng-scope" ng-if="canViewStatus() || canPostToStatus()">
                        ...
                        <div class="section-content shout-container">
                            ...
                            <div class="group-shout ng-scope" ng-if="canViewStatus()">
                                ...
                                <div class="group-shout-body ng-binding">${groupStats?.shout?.body}</div>
                        ...
                        <div class="section" ng-hide="$ctrl.group.memberCount == 0">
                            <div class="container-header group-members-list-container-header">
                                ...
                                <div ng-if="$ctrl.roles.length > 0" class="input-group-btn group-dropdown ng-scope">
                                    ...
                                    ${rolesCopy?.roles.splice(1).reduce((acc, role) => acc  + "<li><a><span class='text-overflow'>" + role.name + "</span><span class='role-member-count'>"+ addCommas(role?.memberCount ?? 0) +"</span></a></li>", "")}
                                    </ul>
                                </div>
                            </div>
            ...
            const createMembers = async (members) => {
                ...
                for (const member of members) {
                    ...
                    <div class="avatar-container"> 
                        ...
                        <span class="text-overflow font-caption-header member-name ng-binding ng-scope" title="${member.displayName}">${member.displayName}</span>
                    </div>
                    `
                ...
                <group-games-item class="game-card game-tile ng-isolate-scope" game="game">
                    <div class="game-card-container"> 
                        <a class="game-card-link" href="https://www.roblox.com/games/${game.rootPlaceId}">
                            ...
                            <div class="game-card-name game-name-title ng-binding" title="${game.name}">${game.name}</div> 
        ...
        setInterval( async () => {
            ...
            try {
                for (let comment of document.getElementsByClassName('list-content')) {
                    ...
                    if (commentTopParent.className.includes("comment") && commentTopParent.style.display != "none") {
                        ...
                        const isReply = stripTags(comment.textContent).match(/\[Replying to (.*): "(.*)"\]/)
                        if (isReply) {
                            ...
                            if (!matchesDid.includes(commentTopParent.id)) {
                                ...
                                const message = isReply[2].replace(/\.\.\.$/, "")
                                ...
                                for (const messageElement of document.getElementsByClassName("comment")) {
                                    ...
                                    if (match && (isReply[2].length < 20 && match[2] == message || (match[2].includes(message) && !match[2].includes(isReply[0]))) && match[1] == userID && !messageElement.classList.contains("isReply")) {
