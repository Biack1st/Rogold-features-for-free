...
pages.upload = (async () => {
    ...
    let assetTypeId = document.getElementById('assetTypeId').value;
    ...
    if (assetTypeIds.indexOf(assetTypeId) >= 0) {
        ...
        const fee = await get(`https://itemconfiguration.roblox.com/v1/avatar-assets/${assetTypeId}/get-upload-fee`)
        let i = 0
